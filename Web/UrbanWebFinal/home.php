			...
			<div class="col-lg-9 col-md-9 col-sm-12">
				<div class="rgt_hd">					
					<div class="main_menu">
						...
						<div id="navbar">
							<ul>
								<li><a class="page-scroll" href="../home.php">Inicio</a></li> 
							<li><a href="#">Nuestras Rutas <i class="fa fa-angle-down"></i></a>
							<ul>
								<li><a class="page-scroll" href="Rutas/haciendasuser.php">Haciendas</a></li>
								<li><a class="page-scroll" href="Rutas/arboledasuser.php">Arboledas</a></li>
								<li><a class="page-scroll" href="Rutas/aztecauser.php">Azteca</a></li>
								<li><a class="page-scroll" href="Rutas/infonavituser.php">Infonavit</a></li>
								<li><a class="page-scroll" href="Rutas/cuauhtemocuser.php">Cuauhtemoc</a></li>
							</ul>
							</li>
                            	<li><a class="page-scroll" href="custom-directions-panel-google-maps-apiv3/directions.html">Traza tu Ruta</a></li> 						
								<li><a class="page-scroll" href="index.php">Salir</a></li>
					...
					<div class="item active">
						<div class="wrap_caption">
						  <div class="caption_carousel">
							<h1>Urban</h1>
							<p>Más Serca de ti, Mas serca de todos</p>
						  </div>						
						</div>
					</div>					
					<div class="item">
						<div class="wrap_caption">
						  <div class="caption_carousel">
							<h1>Urban App</h1>
							<p>Todas Nuestras Rutas, en la palma de tu mano</p>
						  </div>						
						</div>
					</div>					
					<div class="item ">
...
<div class="container">
	<div class="row">	
		...
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			...
			<h4>Usuarios con Nuestro Servicio</h4>	
			</div>
		</div>			
		<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
			<div class="counting_sl">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs12 ">
				<div class="title_sec">
					<h1>Urban Central</h1>
					<h2>Para informarte detalladamente de nuestros servicios particulares, puedes acudir a nuestra matriz</h2>
				</div>			
			</div>		
			<div class="col-sm-6"> 
				<div id="cnt_form">
			...
			<div class="col-lg-6 col-md-6 col-sm-6">
				<div class="cnt_info">
					<ul>
						<li><i class="fa fa-facebook"></i><p>Urban Turismo Tampico</p></li>
...
<div class="container">
	<div class="row">
		<div class="col-lg-12">
			<div class="map">						
			<h1>Urban Central Tampico</h1><a href="#slidingDiv" class="show_hide" rel="#slidingDiv"><i class="fa fa-angle-up"></i></a>
			<div id="slidingDiv">
				<div class="map_area">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<ul class="copy_right">
					<li>&copy;Urban 2016</li>
					<li>developer by Alexander Gomez</li>
				</ul>					
			</div>	
		</div>
	</div>
