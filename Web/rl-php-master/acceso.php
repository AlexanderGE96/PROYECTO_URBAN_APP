...
<head>
  ...
  <link rel="apple-touch-icon-precomposed" sizes="144x144" href="../nova/images/ico/apple-touch-icon-144-precomposed.png">
  <link rel="apple-touch-icon-precomposed" sizes="114x114" href="../nova/images/ico/apple-touch-icon-114-precomposed.png">
        ...
        <div class="navbar-inner">
            <div class="container">
                ...
                <div class="nav-collapse collapse pull-right">
                    <ul class="nav">
                        <li class="active"><a href="../nova/index.html">Inicio</a></li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Rutas <i class="icon-angle-down"></i></a>
                            <ul class="dropdown-menu">
                                <li><a href="../nova/Rutas/Arboledas.html">Arboledas</a></li>
                                <li><a href="../nova/Rutas/Azteca.html">Azteca</a></li>
                                <li><a href="../nova/Rutas/Cuauhtemoc.html">Cuauhtemoc</a></li>
                                <li><a href="../nova/Rutas/Haciendas.html">Haciendas</a></li>
                                <li><a href="../nova/Rutas/Infonavit.html">Infonavit Altamira</a></li>
                                <li class="divider"></li>
                            </ul>
                        </li>
                        <li><a href="../Rutas/custom-directions-panel-google-maps-apiv3/faq.html">Traza tu Ruta</a></li>
                        <li class="login">
                            <a data-toggle="modal" href="#loginForm"><i class="icon-lock"></i></a>
                            <?php if(!isset($_SESSION["user_id"])):?>
                            <li><a href="../rl-php-master/login.html">Iniciar Cecion</a></li>
                            <li><a href="../rl-php-master/registro.html">Registrate</a></li>
                            <?php else:?>
                            <li><a href="../rl-php-master/registro.html">Cerrar Cecion</a></li>
                            <?php endif;?>
                        </li>
                    </ul>        
                </div><!--/.nav-collapse -->
...
<div class="col-md-6">
		...
		<script src="../../rl-php-master/js/valida_registro.js"></script>
  <!-- /#registration-page -->
...
<div class="modal hide fade in" id="loginForm" aria-hidden="false">
    ...
    <div class="modal-body">
        <form class="form-inline" action="../nova/index.html" method="post" id="form-login">
